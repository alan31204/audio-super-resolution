...
# Generic PyTorch model training code
    ...
    def __init__(self, num_classes=1000, log_name ='./run'):
        ...
        self.dconv1 = DLayer(128, 128, 65, stride=2, 32)
        self.dconv2 = DLayer(256, 256, 33, stride=2, 16)
        self.dconv3 = DLayer(512, 512, 17, stride=2, 8)
        self.dconv4 = DLayer(512, 512, 9, stride=2, 4)
        self.dconv5 = DLayer(512, 512, 9, stride=2, 4)
        self.dconv6 = DLayer(512, 512, 9, stride=2, 4)
        self.dconv7 = DLayer(512, 512, 9, stride=2, 4)
        self.dconv8 = DLayer(512, 512, 9, stride=2, 4)
        self.bneck1 = Bottleneck(512, 512, stride=2)
        self.uconv1 = ULayer(512, 512, 9, stride=1, 4)
        self.uconv2 = ULayer(512, 512, 9, stride=1, 4)
        self.uconv3 = ULayer(512, 512, 9, stride=1, 4)
        self.uconv4 = ULayer(512, 512, 9, stride=1, 4)
        self.uconv5 = ULayer(512, 512, 9, stride=1, 4)
        self.uconv6 = ULayer(512, 512, 17, stride=1, 8)
        self.uconv7 = ULayer(256, 256, 33, stride=1, 16)
        self.uconv8 = ULayer(128, 128, 65, stride=1, 32)
